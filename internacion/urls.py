...
urlpatterns = [
    ...
    path('editar_seguimiento/<int:seguimiento_id>/', views.editar_seguimiento, name='editar_seguimiento'),
    path('eliminar_seguimiento/<int:seguimiento_id>/', views.eliminar_seguimiento, name='eliminar_seguimiento'),
